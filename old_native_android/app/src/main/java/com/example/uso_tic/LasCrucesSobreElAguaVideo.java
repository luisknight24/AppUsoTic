...
public class LasCrucesSobreElAguaVideo extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_las_cruces_sobre_el_agua_video);

        // Obtener el VideoView
        VideoView videoView = findViewById(R.id.videoView);

        // Obtener la ruta del archivo de video desde la carpeta 'raw'
        String filePath = "android.resource://" + getPackageName() + "/raw/lascruces";
        ...
        btnRegresarVideo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Regresar a la pantalla principal de Las cruces sobre el agua
                finish();
            }
        });
    }
