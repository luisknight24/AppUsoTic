...
public class LasCrucesSobreElAgua extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_las_cruces_sobre_el_agua);
        ...
        btnVideo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Lógica para redirigir a la vista del video de Las cruces sobre el agua
                abrirVistaVideo();
            }
        });
        ...
        btnPDF.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                abrirPDF("CRUCES_SOBRE_EL_AGUA.pdf");
            }
        });
        ...
        btnActividad.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Ir a la pantalla de actividad de Las cruces sobre el agua
                Intent intent = new Intent(LasCrucesSobreElAgua.this, LasCrucesSobreElAguaActividad.class);
    ...
    private void abrirVistaVideo() {
        Intent intent = new Intent(LasCrucesSobreElAgua.this, LasCrucesSobreElAguaVideo.class);
        startActivity(intent);
    }
