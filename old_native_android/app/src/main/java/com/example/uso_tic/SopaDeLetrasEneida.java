...
public class SopaDeLetrasEneida extends AppCompatActivity {
    private String[] palabras = {"LAENEIDA", "VIRGILIO", "DIDO", "ROMA", "TURNO"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sopa_de_letras_eneida);
    ...
    private void reiniciarJuego() {
        ...
        tvPuntajeObtenido.setText("Puntaje obtenido: 0/10"); // Actualizar el TextView del puntaje
        reiniciarSeleccion();
