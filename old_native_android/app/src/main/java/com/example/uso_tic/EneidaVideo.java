...
public class EneidaVideo extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_eneida_video);

        // Obtener el VideoView
        VideoView videoView = findViewById(R.id.videoView);

        // Obtener la ruta del archivo de video desde la carpeta 'raw'
        String filePath = "android.resource://" + getPackageName() + "/raw/laeneida";
        ...
        btnRegresarVideo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Regresar a la pantalla principal de Eneida
                finish();
            }
        });
    }
