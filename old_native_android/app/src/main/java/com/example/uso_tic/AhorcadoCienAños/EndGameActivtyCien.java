...
import com.example.uso_tic.hangman.EndGameActivity;

import java.util.Objects;
public class EndGameActivtyCien extends AppCompatActivity{
    ...
    {
        Intent intent = new Intent(EndGameActivtyCien.this, Temas.class);
