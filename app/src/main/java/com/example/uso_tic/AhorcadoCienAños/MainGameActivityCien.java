...
import com.example.uso_tic.AhorcadoCruces.EndGameActivityCruces;
import com.example.uso_tic.AhorcadoCruces.ScoreCounterCruces;
import com.example.uso_tic.AhorcadoCruces.WordManagerCruces;
import com.example.uso_tic.AhorcadoCruces.WordProviderCruces;
...
public class MainGameActivityCien extends AppCompatActivity{

    private Set<String> usedWords = new HashSet<>();
    private TableRow myTableRow;
    private WordProviderCien wordProvider;
    ...
    private final WordManagerCien manager = new WordManagerCien();
    private final ScoreCounterCien scoreCounter = new ScoreCounterCien(this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_game_ciena);
        ...
        wordProvider = new WordProviderCien();
    ...
    private void fillTableRow(WordProviderCien wordProvider) {
