...
public class CienAniosDeSoledad extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cien_anios_de_soledad);
        ...
        btnVideo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Lógica para redirigir a la vista del video sobre Cien años de soledad
                abrirVistaVideo();
            }
        });
        ...
        btnPDF.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                abrirPDF("CIEN_ANIOS_DE_SOLEDAD.pdf");
            }
        });
        ...
        btnActividad.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Ir a la pantalla de actividad de Cien años de soledad
                Intent intent = new Intent(CienAniosDeSoledad.this, CienAniosDeSoledadActividad.class);
    ...
    private void abrirVistaVideo() {
        Intent intent = new Intent(CienAniosDeSoledad.this, CienAniosDeSoledadVideo.class);
        startActivity(intent);
    }
