...
public class LaIliadaVideo extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_la_iliada_video);

        // Obtener el VideoView
        VideoView videoView = findViewById(R.id.videoView);

        // Obtener la ruta del archivo de video desde la carpeta 'raw'
        String filePath = "android.resource://" + getPackageName() + "/raw/lailiada";
        ...
        btnRegresarVideo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Regresar a la pantalla principal de La Iliada
                finish();
            }
        });
    }
