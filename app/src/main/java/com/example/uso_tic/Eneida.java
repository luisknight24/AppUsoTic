...
public class Eneida extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_eneida);
        ...
        btnVideo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Lógica para redirigir a la vista del video sobre Eneida
                abrirVistaVideo();
            }
        });
        ...
        btnActividad.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Ir a la pantalla de actividad de La Eneida
                Intent intent = new Intent(Eneida.this, EneidaActividad.class);
    ...
    private void abrirVistaVideo() {
        Intent intent = new Intent(Eneida.this, EneidaVideo.class);
        startActivity(intent);
    }
