...
public class LaOdisea extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_la_odisea);
        ...
        btnVideo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Lógica para redirigir a la vista del video sobre la Odisea
                abrirVistaVideo();
            }
        });
        ...
        btnActividad.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Ir a la pantalla de actividad de La Odisea
                Intent intent = new Intent(LaOdisea.this, LaOdiseaActividad.class);
    ...
    private void abrirVistaVideo() {
        Intent intent = new Intent(LaOdisea.this, LaOdiseaVideo.class);
        startActivity(intent);
    }
