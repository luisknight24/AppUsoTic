...
public class CienAniosDeSoledadVideo extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cien_anios_de_soledad_video);

        // Obtener el VideoView
        VideoView videoView = findViewById(R.id.videoView);

        // Obtener la ruta del archivo de video desde la carpeta 'raw'
        String filePath = "android.resource://" + getPackageName() + "/raw/cienanios";
        ...
        btnRegresarVideo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Regresar a la pantalla principal de Cien años de soledad
                finish();
            }
        });
    }
